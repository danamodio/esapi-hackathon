...
import org.owasp.esapi.impl.encoding.util.Trie;

/**
 * Implementation of the Codec interface for HTML entity encoding. Mostly a
 * migration from the ESAPI 2.0 implementation.
 * 
 * @author Jeff Williams (jeff.williams .at. aspectsecurity.com) <a
 *         href="http://www.aspectsecurity.com">Aspect Security</a>
 * @author Dan Amodio (dan.amodio@aspectsecurity.com)
 */
public class HTMLEntityContext extends BasicContext {
	...
	public HTMLEntityContext() {
		super();
	}

	public String encode(char c) throws UnencodableCharacterException {
		// check for immune characters
		if (getImmune().contains(c)) {
			return "" + c;
		}

		// check for alphanumeric characters
		String hex = HexHelper.getHexForNonAlphanumeric(c);
		if (hex == null) {
			return "" + c;
		}
		...
		return getControlSequence() + hex + getControlSequenceEnd();
	}
	...
	private static synchronized Trie<Character> mkEntityToCharacterTrie() {
		...
		for (Map.Entry<Character, String> entry : characterToEntityMap
				.entrySet())
